...
{
public:
	controlServo(int pinServo,int pinControl,int iPosInicial)
	{  	    
          init(pinServo,pinControl);
          iPOS_Inicial=iPosInicial;        
        }
        
        void init(int pinServo,int pinControl)
        {
	...
	String getStatus()
	{return String(iPinServo)+":"+iPOS_Inicial;}
...
protected:
	...
	int iPOS_Inicial; // Initial Position
	Servo servo;    // servo
